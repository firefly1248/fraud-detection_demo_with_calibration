...
cd calibrated-binary-classifier
...
> **Note**: To generate the calibration comparison plot, run the calibration cells in `build_and_evaluate_model.ipynb` or see [docs/README.md](docs/README.md) for instructions.
